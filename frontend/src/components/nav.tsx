        ...
        {user ? (
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button
                type="button"
                className="hidden shrink-0 items-center gap-2 rounded-sm px-2 py-1.5 text-left text-foreground transition hover:bg-accent md:flex"
              >
                <Avatar size="sm">
          ...
          <button
            ...
            className="hidden shrink-0 items-center gap-2 rounded-sm px-2 py-1.5 text-foreground transition hover:bg-accent md:flex"
          >
