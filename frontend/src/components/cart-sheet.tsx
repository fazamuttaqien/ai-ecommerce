                    ...
                    <div className="flex min-w-0 flex-col gap-3">
                      <div className="flex items-start justify-between gap-3">
                        <div className="min-w-0">
                          <p className="line-clamp-2 text-[14.5px] font-normal! text-muted-foreground max-w-87.5">
                            {item.name}
                          </p>
          ...
          {isCartLoading ? (
            ...
            <>
              ...
              <Button
                ...
                className="h-12 text-base font-semibold rounded-sm disabled:pointer-events-none disabled:bg-neutral-200  disabled:text-neutral-500"
