              ...
              {isCategoriesLoading ? (
                ...
                <>
                  <button
                    ...
                    className={cn(
                      'rounded-sm px-3 py-2 text-left text-sm text-muted-foreground transition hover:bg-muted hover:text-foreground',
                      selectedCategory === 'all' &&
        ...
        <section className="flex min-w-0 flex-col gap-5">
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              >
                ...
                <SelectContent className="rounded-sm">
                  <SelectGroup>
                    <SelectItem value="best-match" className="rounded-sm">
                      Best Match
                    </SelectItem>
                    <SelectItem value="price-low" className="rounded-sm">
                      Price: low to high
                    </SelectItem>
                    <SelectItem value="price-high" className="rounded-sm">
                      Price: high to low
                    </SelectItem>
                    <SelectItem value="highest-rating" className="rounded-sm">
                      Highest rated
                    </SelectItem>
                  </SelectGroup>
                </SelectContent>
          ...
          {isProductsLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center text-muted-foreground">
              ...
              <p className="text-sm">
                Try modifying your category or filter selection.
              </p>
            </div>
          ) : (
            <div className="grid grid-cols-2 gap-x-5 gap-y-8 md:grid-cols-3 xl:grid-cols-4">
