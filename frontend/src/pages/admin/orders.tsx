...
const ALL_STATUS_KEYS: OrderStatus[] = [
  'placed',
  'confirmed',
  'assigned',
  'packed',
            ...
            <Table>
              ...
              <TableBody>
                {orders.length === 0 ? (
                  ...
                  orders.map((order: AdminOrderType) => (
                    <TableRow
                      key={order._id}
                    ...
                    >
                      ...
                      <TableCell className="px-2 py-2 text-sm max-w-50 truncate">
                      ...
                      <TableCell className="px-6 py-2">
                        ...
                        >
                          <SelectTrigger
                            className={cn(
                              'h-9 w-40 font-medium capitalize',
                            ...
                            {ALL_STATUS_KEYS.filter(
                              (statusKey) =>
                                ...
                                !order.statusHistory?.some(
                                  (history) => history.status === statusKey,
                                ),
                            ).map((statusKey) => (
