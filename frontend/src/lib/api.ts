...
export const logoutMutationFn = async (): Promise<{ message: string }> =>
  (await API.post<{ message: string }>('/auth/logout')).data
export const getCurrentUser = async (): Promise<AuthResponse> =>
  (await API.get<AuthResponse>('/auth/status')).data
export const getAllCategoriesQueryFn =
  async (): Promise<CategoryResponseType> =>
    (await API.get<CategoryResponseType>('/categories')).data
...
export const getProductsQueryFn = async (
  ...
  return (
    await API.get<ProductResponseType>('/products', { params: queryParams })
  ).data
}
...
export const getProductBySlugQueryFn = async (
  ...
  (await API.get<ProductDetailResponseType>(`/products/${slug}`)).data
export const getProductReviewsQueryFn = async (
  slug: string,
  params?: { page?: number; limit?: number },
): Promise<ReviewsResponseType> =>
  (await API.get<ReviewsResponseType>(`/products/${slug}/reviews`, { params }))
    .data
export const postAIChat = async (
  data: AIChatRequest,
): Promise<AIChatResponse> =>
  (await API.post<AIChatResponse>('/ai/chat', data)).data
export const getCartQueryFn = async (): Promise<CartResponseType> =>
  (await API.get<CartResponseType>('/cart')).data
export const updateCartMutationFn = async (
  items: { productId: string; quantity: number }[],
): Promise<CartResponseType> =>
  (await API.post<CartResponseType>('/cart', { items })).data
export const getAddressesQueryFn = async (): Promise<GetAddressesResponse> =>
  (await API.get<GetAddressesResponse>('/addresses')).data
export const createAddressMutationFn = async (
  data: CreateAddressInput,
): Promise<AddressResponse> =>
  (await API.post<AddressResponse>('/addresses', data)).data
export const createOrderMutationFn = async (
  data: CreateOrderInput,
): Promise<CreateOrderResponse> =>
  (await API.post<CreateOrderResponse>('/orders', data)).data
export const getOrdersQueryFn = async (): Promise<GetOrdersResponse> =>
  (await API.get<GetOrdersResponse>('/orders')).data
export const getOrderByIdQueryFn = async (
  orderId: string,
): Promise<GetOrderByIdResponse> =>
  (await API.get<GetOrderByIdResponse>(`/orders/${orderId}`)).data
export const getReviewableOrderItemsQueryFn =
  async (): Promise<ReviewableOrdersResponseType> =>
    (await API.get<ReviewableOrdersResponseType>('/reviews/reviewable')).data
export const getUserReviewsQueryFn =
  async (): Promise<UserReviewsResponseType> =>
    (await API.get<UserReviewsResponseType>('/reviews')).data
export const createReviewMutationFn = async (data: {
  ...
  (await API.post<CreateReviewResponseType>('/reviews', data)).data
export const getAdminAnalyticsQueryFn =
  async (): Promise<AdminAnalyticsResponse> =>
    (await API.get<AdminAnalyticsResponse>('/admin/analytics')).data
export const getAdminOrdersQueryFn = async ({
  ...
  (
    await API.get<AdminOrdersResponse>('/admin/orders', {
      params: { page, limit },
    })
  ).data
...
export const getAdminProductsQueryFn = async ({
  ...
  (
    await API.get<AdminProductsResponseType>('/admin/products', {
      params: { page, limit },
    })
  ).data
export const createProductMutationFn = async (
  ...
  (await API.post<CreateProductResponseType>('/admin/products', data)).data
export const uploadProductImagesMutationFn = async (
  ...
  return (
    await API.post<{ images: string[] }>('/admin/products/upload', formData, {
