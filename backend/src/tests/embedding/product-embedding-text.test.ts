...
assert.equal(text, 'Product: Wireless Headphones\nBrand: SoundMax\nDescription: Noise cancelling headphones for travel and work.\nCategory: Audio\nUnit: pc');
assert.equal(buildProductEmbeddingText({ ...product, description: null, category: null }), 'Product: Wireless Headphones\nBrand: SoundMax\nUnit: pc');
